...
public class Sort implements Iterable<Sort.Order>, Serializable {
	 ...
	 *
	 * @param direction
	 *            defaults to {@link Sort#DEFAULT_DIRECTION} (for
	...
	/**
	 * 将给定的 {@link Sort} 中的 {@link Order}s 与当前的 {@link Sort} 结合并返回新的
	 * {@link Sort}
	 *
	 * @param sort
	 *            can be {@literal null}.
